...
pub fn render(listing: &[AssembledLine], error_line: Option<usize>) -> Html {
    if listing.is_empty() {
        return html! {
            <pre style="flex:1; background:#181825; color:#a6adc8; \
                        border:1px solid #313244; border-radius:6px; \
                        padding:12px; font-family:monospace; font-size:13px; \
                        white-space:pre; min-height:0; overflow:auto;">
                {"(click Assemble to see the cor24 listing)"}
            </pre>
        };
    }
    ...
    html! {
        <div style="flex:1; min-height:0; display:flex; \
                    ...
                    overflow:auto; font-family:monospace; font-size:12px; line-height:1.5;">
